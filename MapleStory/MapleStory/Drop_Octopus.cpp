...
int CDrop_Octopus::Ready_GameObject()
{
...
void CDrop_Octopus::Late_Update_GameObject()
{
	float fY = 0.f;
...
//void CDrop_Octopus::Render_GameObject(HDC hDC)
//{
//	UpdateRect_GameObject();
//	int scrollX = 0;
//	int scrollY = 0;
...
//		m_info.sizeY,
//		m_hdc,// 복사 할 대상
//		m_info.sizeX , m_info.sizeY * 2,// 그림의 시작 위치 x,y
...
void CDrop_Octopus::Release_GameObject()
{
}

CGameObject * CDrop_Octopus::Create(float posX, float posY)
{
	CGameObject * instance = new CDrop_Octopus;
